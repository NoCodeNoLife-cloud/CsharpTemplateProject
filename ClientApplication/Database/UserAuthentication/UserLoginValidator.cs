...
public static class UserLoginValidator
{
    ...
    public static async Task<bool> ValidateLoginCredentialsAsync()
    {
        try
        {
            ...
            var (authResult1, userId1, username1) = await UserAuthenticationService.AuthenticateUserAsync("nonexistent_user", "any_password");
            ...
            var (authResult2, userId2, username2) = await UserAuthenticationService.AuthenticateUserAsync(testUsername, testPassword);
            ...
            var (authResult3, userId3, username3) = await UserAuthenticationService.AuthenticateUserAsync(testUsername, wrongPassword);
