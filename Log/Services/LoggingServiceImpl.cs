...
public class LoggingServiceImpl : ILoggingService
{
    ...
    /// </summary>
    /// <returns>Formatted string containing file path and line number in format 'at Client/App/Startup.cs(2)'</returns>
    private static string GetCallerInfo()
    {
        ...
        // Take the last two segments to form a relative path like Client/App/Startup.cs
